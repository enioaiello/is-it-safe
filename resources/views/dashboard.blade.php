            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div style="color: white" class="p-6">
                    <div x-show="page === 'dashboard'">
                        ...
                        <h1 class="text-lg font-medium text-gray-900 dark:text-gray-100" style="display:flex; flex-direction:row;">Bienvenue {{ \Illuminate\Support\Facades\Auth::user()->pseudo }}@include('profile.partials.user-badges')</h1>
